...
window.Whammy = (function(){
  ...
  WhammyVideo.prototype.encodeFrames = function(framecallback, callback){
  ...
  WhammyVideo.prototype.compile = function(outputAsArray, framecallback, callback){

    this.encodeFrames(framecallback, function(){
